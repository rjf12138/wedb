...
void 
BloomFilter::push(int key)
{
    uint32_t h1 = 0, h2 = 0, h3 = 0, h4 = 0;
    algorithm::murmurhash3_x86_32(&key, sizeof(key), 0x234, &h1);
    algorithm::murmurhash3_x86_32(&key, sizeof(key), 0x345, &h2);
    algorithm::murmurhash3_x86_32(&key, sizeof(key), 0x456, &h3);
    algorithm::murmurhash3_x86_32(&key, sizeof(key), 0x678, &h4);
